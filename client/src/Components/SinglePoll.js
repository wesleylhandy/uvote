        ...
        return (
            <section className='poll'>
                ...
                <div className="poll-container">
                    ...
                    <hr />
                    <a className="tweet-container" href={`https://twitter.com/intent/tweet?text=${this.state.title}&url=${encodeURI(`https://u-vote.herokuapp.com/api${this.state.url}`)}&hashtags=onlinepoll`}>
                        <TwitterLogo />
