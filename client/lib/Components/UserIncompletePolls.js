...
var _jsxFileName = 'client/src/Components/UserIncompletePolls.js';
  ...
  _createClass(AllMyPolls, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.state.userId) {
        (0, _helpers.getMyIncompletePolls)(this.state.userId, this.state.isAuth).then(function (res) {
    ...
    value: function renderPolls(polls) {
      ...
      if (polls && polls.length) return _react2.default.createElement(
        ...
        'You do not have any unsaved polls. Please ',
        _react2.default.createElement(
          _reactRouterDom.Link,
